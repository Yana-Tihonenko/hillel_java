...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CarPark[] carParks = new CarPark[8];
        ...
        System.out.println("CarPark cost " + CarPark.countingCost(carParks) + " usd");

        System.out.println("sortByсonsumptionFuel");
        CarPark.sortByсonsumptionFuel(carParks);
        for (CarPark printcar : carParks) {
            System.out.println(printcar.toString());
        }

        System.out.println("filterBySpeedMaxMin");
        CarPark[] filterBySpeedMaxMin = CarPark.filterBySpeedMaxMin(carParks, 150.00, 100.00);
        for (CarPark printcar : filterBySpeedMaxMin) {
            System.out.println(printcar.toString());
        }
    }
}
