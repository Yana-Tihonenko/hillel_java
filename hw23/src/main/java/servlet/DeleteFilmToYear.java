...
public class DeleteFilmToYear extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (resultdelete == true) {
            request.setAttribute("resultdeletesuccessful", "deleteFilmsPage.resultdelete_successful");
        } else
            request.setAttribute("resultdeleteunsuccessful", "deleteFilmsPage.resultdelete_unsuccessful");
