...
import hw18.videolibrary.Actor;
import hw18.videolibrary.Film;
import hw18.videolibrary.Producer;
...
import static hw18.service.ExecuteQueryAndReturnResul.*;
...
public class DBManager {
    ...
    public static List<Film> filmOneTwoReleaseLate() {
        List<Film> filmOneTwoReleaseLate = new ArrayList<>();
    ...
    public static List<Actor> actorToBeProducer() {
        ResultSet resultSet = null;
        List<Actor> actorToBeProducer = new ArrayList<>();
